...
import { getOrganizationalRoles, saveSpeakerProfile } from '../actions/speaker-actions';
import { getSpeakerInfo } from '../actions/auth-actions';

import '../styles/profile-page.less';

const ProfilePage = ({ speaker, orgRoles, loggedMember, errors, loading, history, summit, ...props }) => {
  useEffect(() => {
    if (!speaker) {
  ...
  return (
    <div className="page-wrap" id="profile-page">
      <h3>
        ...
        {' '}
        {T.translate('edit_profile.profile')}
      </h3>
      <hr />
      <SpeakerForm
        entity={speaker}

              ...
              <div className="submit-wrapper" id="submit">
                  ...
                  <div className="row">
                      ...
                      <div className="col-md-6 login-box">
                          ...
                          <a href={`${window.IDP_BASE_URL}/auth/register?client_id=${window.OAUTH2_CLIENT_ID}&redirect_uri=${domain}/${_backUrl}`} className="btn btn-default btn-lg" target="_blank">
